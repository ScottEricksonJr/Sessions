...
# https://stevethompsonmvp.wordpress.com/2021/08/25/create-the-optimize-database-solution-using-powershell-and-dbatools/

#Install-Module dbatools -Force -AllowClobber -Scope AllUsers
